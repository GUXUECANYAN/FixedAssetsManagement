<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssetSearch.aspx.cs" Inherits="FixedAssetsManagement.AssetSearch" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Style="position: absolute; top: 35%; left: 50%; transform: translateX(-50%); width: 600px">
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="width: 200px">
                                    <a href="AssetDetails.aspx?AssetID=<%#:Item.AssetID%>">
